...
function BookCard({ book, onView, liked, onToggleLike }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-sm hover:shadow-lg transition rounded-lg overflow-hidden flex flex-col">
      <div className="relative">
        ...
        <button
          onClick={(e) => { e.stopPropagation(); onToggleLike(book); }}
        ...
        >
          {liked ? (
            ...
            <svg className="w-5 h-5 text-gray-600 dark:text-gray-300" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              <path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M20.8 7.3a5.7 5.7 0 00-8-.6L12 7 11.2 6.7a5.7 5.7 0 00-8 .6 5.4 5.4 0 00-.6 7.1C4 17 12 22 12 22s8-5 9.4-7a5.4 5.4 0 00-.6-7.1z"></path>
            </svg>
          )}
        </button>
      </div>
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">{authorNames}</p>
        <div className="mt-auto flex items-center justify-between">
          <div className="text-xs text-gray-500 dark:text-gray-400">Downloads: {download_count}</div>
